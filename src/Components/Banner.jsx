...
const Banner = () => {
    return (
        <>
            ...
            <div style={bgImage}>
                <div className='container min-h-[650px] flex justify-center items-center py-12 sm:py-0'>
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                        ...
                        <div className='flex flex-col justify-center gap-6 sm:pt-0' >
                            ...
                            <p
                                ...
                                Coffee is a popular beverage made from roasted coffee beans, which are seeds of the Coffea plant. Known for its rich aroma and bold flavor, coffee is enjoyed worldwide for its energizing effects due to caffeine.
                            </p>
                            <div className="grid grid-cols-2 gap-6">
                                <div className='space-y-5' >
                                    ...
                                    <div
                                        data-aos='fade-up' data-aos-delay='500' data-aos-offsett='0'
                                        className='flex items-center gap-3' >
                                ...
                                <div
                                    ...
                                    <p className='text-gray-500 text-sm' >
                                        ...
                                        create a comforting blemd of flavors.
                                    </p>
                                </div>
                            </div>
                        </div>
